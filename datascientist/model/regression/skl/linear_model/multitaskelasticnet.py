...
def _multitaskelasticnet(*, train, test, x_predict=None, metrics, alpha=1.0, l1_ratio=0.5, 
        fit_intercept=True, normalize=False, copy_X=True, max_iter=1000, tol=0.0001, warm_start=False,
    ...
    model = MultiTaskElasticNet(alpha=alpha, l1_ratio=l1_ratio, fit_intercept=fit_intercept, 
        normalize=normalize, max_iter=max_iter, copy_X=copy_X, tol=tol,
        warm_start=warm_start, random_state=random_state, selection=selection)
